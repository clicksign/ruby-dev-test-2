...
ActiveRecord::Schema.define(version: 2022_09_27_015835) do
  ...
  create_table "albums_players", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "album_id"
    t.bigint "player_id"
